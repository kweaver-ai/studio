...
type StorageConfig struct {
	...
	VendorType       string    `gorm:"column:f_vendor_type;type:varchar(32);not null;index" json:"vendor_type"`
	...
	IsDefault        bool      `gorm:"column:f_is_default;type:tinyint(1);default:0" json:"is_default"`
	IsEnabled        bool      `gorm:"column:f_is_enabled;type:tinyint(1);default:1;index" json:"is_enabled"`
	...
	UpdatedAt        time.Time `gorm:"column:f_updated_at;autoUpdateTime" json:"updated_at"`
}
